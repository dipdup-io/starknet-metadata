module github.com/dipdup-io/starknet-metadata
...
require (
	...
	github.com/dipdup-io/starknet-indexer v0.0.0-20240716180702-eae419e4ff6f
	github.com/dipdup-io/workerpool v0.0.4
	github.com/dipdup-net/go-lib v0.4.4
